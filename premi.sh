...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/Ahmaddevx/Regist/main/afk | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/Ahmaddevx/Regist/main/afk | grep $ipsaya | awk '{print $3}')
...
wget https://raw.githubusercontent.com/Ahmaddevx/Ahmaddevx-Tunnel/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
