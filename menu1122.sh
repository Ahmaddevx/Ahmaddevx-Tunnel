...
# // USERNAME IZIN IPP
rm -f /usr/bin/user
username=$(curl -sS https://raw.githubusercontent.com/Ahmaddevx/Regist/main/afk | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user

# // VALIDITY
rm -f /usr/bin/e
valid=$(curl -sS https://raw.githubusercontent.com/Ahmaddevx/Regist/main/afk | grep $MYIP | awk '{print $3}')
...
Exp1=$(curl -sS https://raw.githubusercontent.com/Ahmaddevx/Regist/main/afk | grep $MYIP | awk '{print $3}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
REVISI="https://raw.githubusercontent.com/Ahmaddevx/Ahmaddevx-Tunnel/main/"
