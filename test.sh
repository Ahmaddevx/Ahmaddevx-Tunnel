...
TIME=$(date '+%d %b %Y')
REPO="https://raw.githubusercontent.com/Ahmaddevx/hah/main/"
TIMES="10"
CHATID="5651317408"
...
apete_apdet() {
    ...
    wget raw.githubusercontent.com/Ahmaddevx/hah/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
...
Documentation=https://github.com/Ahmaddevx
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/Ahmaddevx/izin/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/Ahmaddevx/izin/main/ip | grep $ipsaya | awk '{print $3}')
